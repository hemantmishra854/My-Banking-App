...
public class MainCardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.spinner_select_card);
        ...
        applyButton = findViewById(R.id.button_apply_for_card);
        ...
        applyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spinner.getSelectedItem().toString().equals("Select Card")) {
                    Toast.makeText(MainCardsActivity.this, "Select Card",
                ...
                databaseReference.child(applicationId).setValue(fundTransferDetails)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                finish();
                                Toast.makeText(MainCardsActivity.this,
                                        "Your card request submitted successfully",
                                        Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(MainCardsActivity.this,
