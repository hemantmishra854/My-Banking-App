...
public class MainLoanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.spinner_select_loan);
        adapter = ArrayAdapter.createFromResource(this,
                R.array.loan_type, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("loan_requests");
        ...
        applyButton = findViewById(R.id.button_apply_for_loan);
        ...
        applyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spinner.getSelectedItem().toString().equals("Select Loan")) {
                    Toast.makeText(MainLoanActivity.this, "Select Loan",
                ...
                databaseReference.child(applicationId).setValue(fundTransferDetails)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                finish();
                                Toast.makeText(MainLoanActivity.this,
                                        "Your loan request submitted successfully",
                                        Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(MainLoanActivity.this,
